      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <Card className="text-center">
            <div className="w-16 h-16 eksu-button-primary rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <Link href="/enrollment">
              <Button size="lg" variant='brand' className="w-full variantStyles[brand]">
                Start Enrollment
              </Button>
            </Link>
          </Card>
          ...
          <Card className="text-center">
            ...
            <p className="text-gray-600 mb-6">
              Verify student identity instantly using fingerprint biometrics for secure access and services.
            </p>
